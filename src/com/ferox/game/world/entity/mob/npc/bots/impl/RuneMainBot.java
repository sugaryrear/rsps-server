...
public class RuneMainBot extends NPCBotHandler implements CombatMethod {
    ...
    public void process() {
        ...
        if (CombatFactory.inCombat(npc)) {
            ...
            if (inDistance && npc.getSpecialAttackPercentage() > CombatSpecial.DRAGON_DAGGER.getDrainAmount() && opponent.hp() <= 70) {
    ...
    public void onDeath(Player killer) {
        ...
        GroundItemHandler.createGroundItem(new GroundItem(new Item(13307, World.getWorld().random(2500)), npc.tile(),killer));
