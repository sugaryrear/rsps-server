package com.ferox.game.content.diary.fremennik;
...
import static com.ferox.game.content.diary.fremennik.FremennikDiaryEntry.*;
...
public final class FremennikAchievementDiary extends StatefulAchievementDiary<FremennikDiaryEntry> {
    ...
    public void updateDiary() {
        int diaryId = 29501; //+2 = name, +3 = amount, +4 = easy , +5 = med, +6 = hard, +7 elite
        player.getPacketSender().sendFrame126((hasDoneAll() ? "@gre@Fremennik" : "@yel@Fremennik"), diaryId+2);
...
//    }
    ...
    public void display() {
        ...
        player.getPacketSender().sendFrame126("@dre@Fremennik Diary", 8144);
