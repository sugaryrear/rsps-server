...
import static com.ferox.game.content.diary.falador.FaladorDiaryEntry.*;
...
public final class FaladorAchievementDiary extends StatefulAchievementDiary<FaladorDiaryEntry> {
    ...
    public void updateDiary() {
        int diaryId = 29491; //+2 = name, +3 = amount, +4 = easy , +5 = med, +6 = hard, +7 elite
        player.getPacketSender().sendFrame126((hasDoneAll() ? "@gre@Falador" : "@yel@Falador"), diaryId+2);
...
//    }
    ...
    public void display() {
        ...
        player.getPacketSender().sendFrame126("@dre@Falador Diary", 8144);
