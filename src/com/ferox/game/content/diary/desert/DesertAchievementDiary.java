package com.ferox.game.content.diary.desert;
...
import static com.ferox.game.content.diary.desert.DesertDiaryEntry.*;
...
public final class DesertAchievementDiary extends StatefulAchievementDiary<DesertDiaryEntry> {
    ...
    public void updateDiary() {
        int diaryId = 29481; //+2 = name, +3 = amount, +4 = easy , +5 = med, +6 = hard, +7 elite
        player.getPacketSender().sendFrame126((hasDoneAll() ? "@gre@Desert" : "@yel@Desert"), diaryId+2);
...
//    }
    ...
    public void display() {
        ...
        player.getPacketSender().sendFrame126("@dre@Desert Diary", 8144);
