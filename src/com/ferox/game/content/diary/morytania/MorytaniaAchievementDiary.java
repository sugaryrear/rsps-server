package com.ferox.game.content.diary.morytania;
...
import static com.ferox.game.content.diary.morytania.MorytaniaDiaryEntry.*;
...
public final class MorytaniaAchievementDiary extends StatefulAchievementDiary<MorytaniaDiaryEntry> {
    ...
    public void updateDiary() {
        int diaryId = 29571; //+2 = name, +3 = amount, +4 = easy , +5 = med, +6 = hard, +7 elite
        player.getPacketSender().sendFrame126((hasDoneAll() ? "@gre@Morytania" : "@yel@Morytania"), diaryId+2);
...
//    }
    ...
    public void display() {
        ...
        player.getPacketSender().sendFrame126("@dre@Morytania Diary", 8144);
