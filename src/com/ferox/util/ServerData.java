...
public class ServerData{
     ...
     */
    private SerializablePair<String, Long> coxTime;
    private SerializablePair<String, Long> nexTime;
    private TopPkers topPkers;
    public TopPkers getTopPkers() {
        return topPkers;
    }

    public void setTopPkers(TopPkers toppkers) {
        this.topPkers = toppkers;
        requestUpdate("topPkers");
    }

    private TopPkersWeekly topPkersWeekly;
    public TopPkersWeekly getTopPkersWeekly() {
        return topPkersWeekly;
    }

    public void setTopPkersWeekly(TopPkersWeekly toppkersweekly) {
        this.topPkersWeekly = toppkersweekly;
        requestUpdate("topPkersWeekly");
    }


    private TopBossPointsWeekly topBossPointsWeekly;
    public TopBossPointsWeekly getTopBossPointsWeekly() {
        return topBossPointsWeekly;
    }

    public void setTopBossPointsWeekly(TopBossPointsWeekly topbosspointsweekly) {
        this.topBossPointsWeekly = topbosspointsweekly;
        requestUpdate("topBossPointsWeekly");
    }

    private TopBossPoints topBossPoints;
    public TopBossPoints getTopBossPoints() {
        return topBossPoints;
    }

    public void setTopBossPoints(TopBossPoints topbosspoints) {
        this.topBossPoints = topbosspoints;
        requestUpdate("topBossPoints");
    }
    private TopPkersDaily topPkersDaily;
    public TopPkersDaily getTopPkersDaily() {
        return topPkersDaily;
    }

    public void setTopPkersDaily(TopPkersDaily toppkersdaily) {
        this.topPkersDaily = toppkersdaily;
        requestUpdate("topPkersDaily");
    }



    private TopBossPointsDaily topBossPointsDaily;
    public TopBossPointsDaily getTopBossPointsDaily() {
        return topBossPointsDaily;
    }

    public void setTopBossPointsDaily(TopBossPointsDaily topbosspointsdaily) {
        this.topBossPointsDaily = topbosspointsdaily;
        requestUpdate("topBossPointsDaily");
    }


    private TopXP topXP;
    public TopXP getTopXP() {
        return topXP;
    }

    public void setTopXP(TopXP topxp) {
        this.topXP = topxp;
        requestUpdate("topXP");
    }

    private TopXPWeekly topXPweekly;
    public TopXPWeekly getTopXPWeekly() {
        return topXPweekly;
    }

    public void setTopXPWeekly(TopXPWeekly topxpweekly) {
        this.topXPweekly = topxpweekly;
        requestUpdate("topXPweekly");
    }


    private TopXPDaily topXPdaily;
    public TopXPDaily getTopXPDaily() {
        return topXPdaily;
    }

    public void setTopXPDaily(TopXPDaily topxpdaily) {
        this.topXPdaily = topxpdaily;
        requestUpdate("topXPdaily");
    }
...
//        }
    ...
    public SerializablePair<String, Long> getNexTime() {
        return nexTime;
    }
    /**
     * Modifies the best time it took to beat zulrah
     *
     * @param coxTime the new best time
     */
    public void setSerializablePair(SerializablePair<String, Long> coxTime) {
        this.coxTime = coxTime;
        requestUpdate("coxTime");
    }
    public void setSerializablePairNex(SerializablePair<String, Long> nexTime) {
        this.nexTime = nexTime;
        requestUpdate("nexTime");
    }
}
