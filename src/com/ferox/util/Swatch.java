...
public final class Swatch {
     ...
     */
    private long cachedTime = Swatch.currentTime();
    ...
    public long elapsedTime(TimeUnit unit) {
        ...
        return unit.convert((Swatch.currentTime() - cachedTime), TimeUnit.MILLISECONDS);
    }
    ...
    public static final class AtomicStopwatch {
         ...
         * The internal cached time that acts as a time stamp.
         */
        private final AtomicLong cachedTime = new AtomicLong(Swatch.currentTime());
        ...
        public AtomicStopwatch reset() {
            cachedTime.set(Swatch.currentTime());
        ...
        public long elapsedTime(TimeUnit unit) {
            if(state.get() == State.STOPPED)
                throw new IllegalStateException("The timer has been stopped!");
            return unit.convert((Swatch.currentTime() - cachedTime.get()), TimeUnit.MILLISECONDS);
        }
